...
import 'package:pills_app/repository/firebase/user_firestore.dart';
import '../repository/firebase/auth_service.dart';
                        ...
                        ? () async {
                            try {
                              ...
                              if (result == SignUpResult.success) {
                                ...
                                setState(() {
                                  passwordErrorMessage = 'パスワードが短すぎます';
                                  isButtonEnabled = false;
                                });
                              } else if (result ==
                                ...
                                setState(() {
                                  emailErrorMessage = 'メールアドレスが既に登録されています';
                                  isButtonEnabled = false;
                                });
                              } else {
                                setState(() {
                                  errorMessage = 'アカウントが作成できませんでした';
                                  isButtonEnabled = false;
                                });
                              }
                            } catch (e) {
